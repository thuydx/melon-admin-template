<?php
define('ASSETS_URL', 'http://assets.template.local/bo/default/');
?>
...
<html lang="en">
    <head>
        ...
        <!-- Theme -->
        <link href="<?php echo ASSETS_URL; ?>assets/css/main.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo ASSETS_URL; ?>assets/css/plugins.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo ASSETS_URL; ?>assets/css/responsive.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo ASSETS_URL; ?>assets/css/icons.css" rel="stylesheet" type="text/css" />

        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>assets/css/fontawesome/font-awesome.min.css">
        <!--[if IE 7]>
                <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>assets/css/fontawesome/font-awesome-ie7.min.css">
        <![endif]-->

        <!--[if IE 8]>
                <link href="<?php echo ASSETS_URL; ?>assets/css/ie8.css" rel="stylesheet" type="text/css" />
        <![endif]-->
        <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,600,700' rel='stylesheet' type='text/css'>

        <!--=== JavaScript ===-->

        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>assets/js/libs/jquery-1.10.2.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/jquery-ui/jquery-ui-1.10.2.custom.min.js"></script>

        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>bootstrap/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>assets/js/libs/lodash.compat.min.js"></script>

        <!-- HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
                <script src="<?php echo ASSETS_URL; ?>assets/js/libs/html5shiv.js"></script>
        <![endif]-->

        <!-- Smartphone Touch Events -->
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/touchpunch/jquery.ui.touch-punch.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/event.swipe/jquery.event.move.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/event.swipe/jquery.event.swipe.js"></script>

        <!-- General -->
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>assets/js/libs/breakpoints.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/respond/respond.min.js"></script> <!-- Polyfill for min/max-width CSS3 Media Queries (only for IE8) -->
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/cookie/jquery.cookie.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/slimscroll/jquery.slimscroll.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/slimscroll/jquery.slimscroll.horizontal.min.js"></script>

        <!-- Page specific plugins -->
        <!-- Charts -->
        <!--[if lt IE 9]>
                <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/flot/excanvas.min.js"></script>
        <![endif]-->
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/sparkline/jquery.sparkline.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/flot/jquery.flot.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/flot/jquery.flot.tooltip.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/flot/jquery.flot.resize.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/flot/jquery.flot.time.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/flot/jquery.flot.growraf.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/easy-pie-chart/jquery.easy-pie-chart.min.js"></script>

        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/daterangepicker/moment.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/daterangepicker/daterangepicker.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/blockui/jquery.blockUI.min.js"></script>

        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/fullcalendar/fullcalendar.min.js"></script>

        <!-- Noty -->
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/noty/jquery.noty.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/noty/layouts/top.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/noty/themes/default.js"></script>

        <!-- Forms -->
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/uniform/jquery.uniform.min.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>plugins/select2/select2.min.js"></script>

        <!-- App -->
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>assets/js/app.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>assets/js/plugins.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>assets/js/plugins.form-components.js"></script>
        ...
        <!-- Demo JS -->
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>assets/js/custom.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>assets/js/demo/pages_calendar.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>assets/js/demo/charts/chart_filled_blue.js"></script>
        <script type="text/javascript" src="<?php echo ASSETS_URL; ?>assets/js/demo/charts/chart_simple.js"></script>
    </head>
        ...
        <header class="header navbar navbar-fixed-top" role="banner">
            ...
            <div class="container">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="<?php echo ASSETS_URL; ?>assets/img/logo.png" alt="logo" />
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown hidden-xs hidden-sm">
                        ...
                        <ul class="dropdown-menu extended notification">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <span class="photo"><img src="<?php echo ASSETS_URL; ?>assets/img/demo/avatar-1.jpg" alt="" /></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <span class="photo"><img src="<?php echo ASSETS_URL; ?>assets/img/demo/avatar-2.jpg" alt="" /></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <span class="photo"><img src="<?php echo ASSETS_URL; ?>assets/img/demo/avatar-3.jpg" alt="" /></span>
                                    <span class="subject">
                    ...
                    <li class="dropdown user">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <!--<img alt="" src="<?php echo ASSETS_URL; ?>assets/img/avatar1_small.jpg" />-->
                            <i class="icon-male"></i>
